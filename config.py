...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7287032614"))
...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/c/2257457147/3") # shareus ka tut_vid he 
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7287032614").split()):
        ADMINS.append(int(x))
except ValueError:
